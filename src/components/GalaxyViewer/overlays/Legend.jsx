            ...
            <div className="border-t border-white/5 pt-2 mt-2">
              <div className="flex items-start gap-1.5">
                ...
                <p className="text-[8px] text-white/30 leading-relaxed">
                  The GraphSAGE GNN aggregates information from neighbors up to <span className="text-purple-300">3 hops</span> away.
                  Each hop expands the receptive field, allowing the model to learn from increasingly distant drug relationships.
                </p>
              </div>
            </div>
