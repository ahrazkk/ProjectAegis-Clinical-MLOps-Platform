              ...
              <Box>
                ...
                <div className="hidden md:flex items-center justify-between gap-2">
                  {[
                    ...
                    { label: 'Graph Featurizer', sub: 'Atoms \u2192 Nodes\nBonds \u2192 Edges', highlight: false },
                    { label: 'GIN Layers \u00d73', sub: 'Message Passing\n+ JK Connections', highlight: true, hcolor: 'cyan' },
                ...
                <div className="md:hidden space-y-3">
                  {[
                    'SMILES Input \u2192 Graph Featurizer \u2192 GIN Layers \u00d73',
                    'Graph Pooling \u2192 Classifier \u2192 Platt Scaling',
                  ].map((line) => (
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <Box>
                  ...
                  <div className="space-y-4">
                    <MetricBar label="PR-AUC" value={79.0} color="#00ff88" index={0} />
                    <MetricBar label="Val Accuracy" value={66.0} color="#00d4ff" index={1} />
                    <MetricBar label="Positive Precision" value={78.3} color="#a855f7" index={2} />
                    <MetricBar label="Calibrated (DDI pairs)" value={78.3} max={100} color="#00ff88" suffix="% avg" index={3} />
                  ...
                  <div className="mt-6 text-[9px] text-fui-gray-500 border-t border-fui-gray-500/20 pt-4 space-y-1">
                    ...
                    <div>Warfarin + Aspirin: raw 0.994 &rarr; calibrated <span className="text-green-400">0.783</span></div>
